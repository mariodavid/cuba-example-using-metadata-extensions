...
public class CeumeTestContainer extends TestContainer {

    public CeumeTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/ceume/app.properties",
    ...
    public static class Common extends CeumeTestContainer {

        public static final CeumeTestContainer.Common INSTANCE = new CeumeTestContainer.Common();
